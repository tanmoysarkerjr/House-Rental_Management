...
export default function PropertyDetails() {
  ...
  const property = {
    ...
    rating: 4.8,
    reviews: 24,
    description: "Experience luxury living in this beautifully designed 2-bedroom apartment located in the heart of Banani. This modern residence features spacious rooms, premium finishes, and abundant natural light. Perfect for families or professionals seeking comfort and convenience.",
    images: [
          ...
          <div className="details-main">
            ...
            <div className="image-gallery">
              <div className="main-image">
                ...
                <button className="gallery-nav prev" onClick={() => setCurrentImageIndex((currentImageIndex - 1 + property.images.length) % property.images.length)}>‹</button>
                <button className="gallery-nav next" onClick={() => setCurrentImageIndex((currentImageIndex + 1) % property.images.length)}>›</button>
              </div>
          ...
          <aside className="details-sidebar">
            ...
            <div className="price-card">
              ...
              {property.availableFrom && (
                <p className="available-from">Available from: <strong>{property.availableFrom}</strong></p>
              )}

              <button className="btn-contact-owner" onClick={() => setShowContactForm(!showContactForm)}>
                💬 Contact Owner
              </button>
              
              <button className="btn-schedule-visit">
                📅 Schedule Visit
              </button>
